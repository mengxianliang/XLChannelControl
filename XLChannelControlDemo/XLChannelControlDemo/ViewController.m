...
-(void)showChannel
{
    ...
    [[XLChannelControl shareControl] showChannelViewWithEnabledTitles:arr1 disabledTitles:arr2 finish:^(NSArray *enabledTitles, NSArray *disabledTitles) {
        NSLog(@"inUseTitles = %@",enabledTitles);
        NSLog(@"unUseTitles = %@",disabledTitles);
    }];
}
